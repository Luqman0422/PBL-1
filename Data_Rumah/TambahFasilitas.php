          ...
          <div class="card-body">
            <div class="form-group">
             <div class="card-body">
               ...
               <input type="file" name="FotoFas" required=""></input>
             </div>
           </div>
           <div class="form-group">     
            <label for="exampleInputName">Nama Fasilitas</label>
            <input class="form-control" type="text" aria-describedby="nameHelp" name="NamaFas" required=""></input>
          </div>
          <div class="form-group">     
            <label for="exampleInputName">Keterangan</label>
            <textarea class="form-control" type="textarea" aria-describedby="nameHelp" name="Keterangan" required=""></textarea>
          </div>
