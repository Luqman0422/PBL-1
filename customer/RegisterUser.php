...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-primary navbar-dark fixed-top" id="sideNav" >
    ...
    <p style="color: white;">Silahkan Isi Form Registrasi</p>
        ...
        <div class="login-container">
          ...
          <?php
            if($_GET['stat']){
              if($_GET['stat']=='user'){
                ?>
                  <alert alert-danger>Username Sudah ada</alert>
                <?php
              }
              else if($_GET['stat']=='gagal'){
                ?>
                  <alert>Registrasi gagal</alert>
                <?php
              }
              else{}
            }
          ...
          <div class="form-box">
            <h3>Register User</h3>
            <form action="do_log.php?id=<?php echo "$id"; ?>" method="post">
            ...
            <a style="font-size: 15px; margin-top: 15px; color: black; text-decoration: none; color: black; float: left;" href="login.php?id=<?php echo "$id"; ?>">Back to login</a>
          </div>
        </div>
