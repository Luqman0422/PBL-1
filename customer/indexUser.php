...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="indexUser.php?page=Home">Home</a>
        </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="indexUser.php?page=Simulasi">Simulasi Cicilan</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="indexUser.php?page=Booking&id=">Form Booking</a>
          </li>
          <?php
