...
function magnify(imgID, zoom) {
  ...
  function getCursorPos(e) {
	...
	<section class="listings">
		<div class="wrapper">
            ...
            <button class="w3-button w3-brown" onclick="document.getElementById('modal01').style.display='block'">Lihat Siteplan</button>
			  </li>
        <li style="margin-right: 5px; margin-left: 15px;">

            <a href="login.php?id=<?php echo $data['id_rumah']; ?>"><button class="w3-button w3-brown">Booking!</button></a>
        </li>
			  </ul>
			...
			<ul class="properties_list">
				...
				<li style="margin-right: 5px; margin-left: 15px; width: 100%;">
					<h2>Harga : Rp.<?php $hasil=$data['Harga'];
  ...
  <div id="modal01" class="w3-modal" onclick="this.style.display='none'">
    ...
    <div class="img-magnifier-container">
      <img src="img/site.jpg" style="width:10000px;" id="myimage">
     </div>
    </div>
  </div>
